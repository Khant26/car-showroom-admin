...
export const apiService = {
  ...
  banners: {
    ...
    updateStatus: (id, isActive) =>
      api.patch(`/banners/${id}/status`, { isActive }),
  ...
  cars: {
    ...
    updateStatus: (id, isAvailable) =>
      api.patch(`/cars/${id}/status`, { isAvailable }),
    toggleFeatured: (id, isFeatured) =>
      api.patch(`/cars/${id}/featured`, { isFeatured }),
  },

  soldCars: {
    getAll: (params = {}) => api.get("/sold-cars", { params }),
    getById: (id) => api.get(`/sold-cars/${id}`),
    create: (data) => {
      const config = {};
      if (data instanceof FormData) {
        config.headers = { "Content-Type": "multipart/form-data" };
      }
      return api.post("/sold-cars", data, config);
    },
    update: (id, data) => {
      const config = {};
      if (data instanceof FormData) {
      ...
      return api.put(`/sold-cars/${id}`, data, config);
    },
    delete: (id) => api.delete(`/sold-cars/${id}`),
  },
